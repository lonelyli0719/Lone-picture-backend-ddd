package com.lone.lonepicture.shared.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // lone_picture.picture_111111, lone_picture.picture_222222, lone_picture.picture_333333
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "lone_picture." + tableName) // 确保前缀合法
